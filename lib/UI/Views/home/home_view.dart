...
import 'package:epic_games_ui/globals.dart';
    ...
    return ViewModelBuilder<HomeViewModel>.reactive(
      builder: (context, model, child) {
        return Scaffold(
          ...
          drawer: buildLeft(context, model),
          body: Container(
            ...
            child: BackdropFilter(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    //Container(child: buildLeft(model)),
                    Row(
                      ...
                      children: [
                        ...
                        //Container(child: buildRightRight(context, model))
                      ],
                    ),
                  ],
                ),
...
Widget buildLeft(context, HomeViewModel model) {
  ...
  return Material(
    ...
    child: Row(
      children: [
        Container(
          //width: (gb.isleftWidgetCollapsed==true)? 0: MediaQuery.of(context).size.width * .20, //21.width,
          //height: 100.height,
          decoration: BoxDecoration(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: CircleAvatar(
                            ...
                            //backgroundImage:AssetImage('assets/images/bert_image.jpg'),
                          ),
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: 3.1.width, right: 3.1.width, bottom: 10),
                    child: Padding(
...
Widget buildRightRight(BuildContext context, HomeViewModel model) {
  var textTheme = Theme.of(context).textTheme;
  return Material(
    child: Container(
      margin: EdgeInsets.symmetric(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(8),
                      image: DecorationImage(
                        image: AssetImage('assets/images/cycle_screen_1.jpeg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(8),
                      image: DecorationImage(
                        image: AssetImage('assets/images/cycle_screen_2.jpeg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
